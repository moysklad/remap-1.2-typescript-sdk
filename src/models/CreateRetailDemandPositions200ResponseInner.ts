...
/**
 * @type CreateRetailDemandPositions200ResponseInner
 * 
 * @export
 */
...
export function CreateRetailDemandPositions200ResponseInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateRetailDemandPositions200ResponseInner {
    if (json == null) {
        return json;
    }
...
export function CreateRetailDemandPositions200ResponseInnerToJSON(json: any): any {
    return CreateRetailDemandPositions200ResponseInnerToJSONTyped(json, false);
}

export function CreateRetailDemandPositions200ResponseInnerToJSONTyped(value?: CreateRetailDemandPositions200ResponseInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
