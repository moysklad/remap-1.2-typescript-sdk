 ...
 * 
 * @export
 * @interface ScriptTemplatePermissions
 */
export interface ScriptTemplatePermissions {
    /**
     * Смотреть. Известные значения описаны в PermissionValue.
     * @type {string}
     * @memberof ScriptTemplatePermissions
     */
    view?: string;
    /**
    ...
    _delete?: string;
    /**
     * Выполнять. Известные значения описаны в PermissionValue.
     * @type {string}
     * @memberof ScriptTemplatePermissions
     */
    activate?: string;
...
/**
 * Check if a given object implements the ScriptTemplatePermissions interface.
 */
export function instanceOfScriptTemplatePermissions(value: object): value is ScriptTemplatePermissions {
    return true;
}

export function ScriptTemplatePermissionsFromJSON(json: any): ScriptTemplatePermissions {
    return ScriptTemplatePermissionsFromJSONTyped(json, false);
}

export function ScriptTemplatePermissionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ScriptTemplatePermissions {
    if (json == null) {
        return json;
    }
    return {
...
export function ScriptTemplatePermissionsToJSON(json: any): ScriptTemplatePermissions {
    return ScriptTemplatePermissionsToJSONTyped(json, false);
}

export function ScriptTemplatePermissionsToJSONTyped(value?: ScriptTemplatePermissions | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    return {
