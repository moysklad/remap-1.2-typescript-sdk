...
/**
 * Check if a given object implements the CurrencyMajorUnit interface.
 */
export function instanceOfCurrencyMajorUnit(value: object): value is CurrencyMajorUnit {
    return true;
}

export function CurrencyMajorUnitFromJSON(json: any): CurrencyMajorUnit {
    return CurrencyMajorUnitFromJSONTyped(json, false);
}

export function CurrencyMajorUnitFromJSONTyped(json: any, ignoreDiscriminator: boolean): CurrencyMajorUnit {
    if (json == null) {
        return json;
    }
    return {
...
export function CurrencyMajorUnitToJSON(json: any): CurrencyMajorUnit {
    return CurrencyMajorUnitToJSONTyped(json, false);
}

export function CurrencyMajorUnitToJSONTyped(value?: CurrencyMajorUnit | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    return {
