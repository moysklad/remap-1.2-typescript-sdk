...
/**
 * Check if a given object implements the CountryList interface.
 */
export function instanceOfCountryList(value: object): value is CountryList {
    return true;
}

export function CountryListFromJSON(json: any): CountryList {
    return CountryListFromJSONTyped(json, false);
}

export function CountryListFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountryList {
    if (json == null) {
        return json;
    }
    return {
        ...
        'rows': json['rows'] == null ? undefined : ((json['rows'] as Array<any>).map(CountryFromJSON)),
    };
}

export function CountryListToJSON(json: any): CountryList {
    return CountryListToJSONTyped(json, false);
}

export function CountryListToJSONTyped(value?: CountryList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'rows': value['rows'] == null ? undefined : ((value['rows'] as Array<any>).map(CountryToJSON)),
    };
}
