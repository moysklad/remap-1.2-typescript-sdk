 ...
 * @export
 * @interface ExpenseItemList
 */
export interface ExpenseItemList {
    /**
     * 
     * @type {Context}
     * @memberof ExpenseItemList
     */
    context?: Context;
    /**
     * 
...
/**
 * Check if a given object implements the ExpenseItemList interface.
 */
export function instanceOfExpenseItemList(value: object): value is ExpenseItemList {
    return true;
}

export function ExpenseItemListFromJSON(json: any): ExpenseItemList {
    return ExpenseItemListFromJSONTyped(json, false);
}

export function ExpenseItemListFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExpenseItemList {
    if (json == null) {
        return json;
    }
    return {
        ...
        'rows': json['rows'] == null ? undefined : ((json['rows'] as Array<any>).map(ExpenseItemFromJSON)),
    };
}

export function ExpenseItemListToJSON(json: any): ExpenseItemList {
    return ExpenseItemListToJSONTyped(json, false);
}

export function ExpenseItemListToJSONTyped(value?: ExpenseItemList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'rows': value['rows'] == null ? undefined : ((value['rows'] as Array<any>).map(ExpenseItemToJSON)),
    };
}
