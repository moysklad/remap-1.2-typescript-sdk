 ...
 * @export
 * @interface FactureOutList
 */
export interface FactureOutList {
    /**
     * 
     * @type {Context}
     * @memberof FactureOutList
     */
    context?: Context;
    /**
     * 
    ...
    meta?: MetaList;
    /**
     * Массив Счетов-фактур выданных
     * @type {Array<FactureOut>}
     * @memberof FactureOutList
     */
    rows?: Array<FactureOut>;
}


/**
 * Check if a given object implements the FactureOutList interface.
 */
export function instanceOfFactureOutList(value: object): value is FactureOutList {
    return true;
}

export function FactureOutListFromJSON(json: any): FactureOutList {
    return FactureOutListFromJSONTyped(json, false);
}

export function FactureOutListFromJSONTyped(json: any, ignoreDiscriminator: boolean): FactureOutList {
    if (json == null) {
        return json;
    }
    return {
        ...
        'rows': json['rows'] == null ? undefined : ((json['rows'] as Array<any>).map(FactureOutFromJSON)),
    };
}

export function FactureOutListToJSON(json: any): FactureOutList {
    return FactureOutListToJSONTyped(json, false);
}

export function FactureOutListToJSONTyped(value?: FactureOutList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'rows': value['rows'] == null ? undefined : ((value['rows'] as Array<any>).map(FactureOutToJSON)),
    };
}
