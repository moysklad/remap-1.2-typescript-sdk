...
export interface LossList {
     ...
     * @memberof LossList
     */
    rows?: Array<Loss> | null;
}


/**
 * Check if a given object implements the LossList interface.
 */
export function instanceOfLossList(value: object): value is LossList {
    return true;
}

export function LossListFromJSON(json: any): LossList {
    return LossListFromJSONTyped(json, false);
}

export function LossListFromJSONTyped(json: any, ignoreDiscriminator: boolean): LossList {
    if (json == null) {
        return json;
    }
    return {
        ...
        'rows': json['rows'] == null ? undefined : ((json['rows'] as Array<any>).map(LossFromJSON)),
    };
}

export function LossListToJSON(json: any): LossList {
    return LossListToJSONTyped(json, false);
}

export function LossListToJSONTyped(value?: LossList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'rows': value['rows'] == null ? undefined : ((value['rows'] as Array<any>).map(LossToJSON)),
    };
}
