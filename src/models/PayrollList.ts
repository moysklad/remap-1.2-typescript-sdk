...
import type { Payroll } from './Payroll.js';
import {
    PayrollFromJSON,
...
/**
 * Check if a given object implements the PayrollList interface.
 */
export function instanceOfPayrollList(value: object): value is PayrollList {
    return true;
}

export function PayrollListFromJSON(json: any): PayrollList {
    return PayrollListFromJSONTyped(json, false);
}

export function PayrollListFromJSONTyped(json: any, ignoreDiscriminator: boolean): PayrollList {
    if (json == null) {
        return json;
    }
    return {
        ...
        'rows': json['rows'] == null ? undefined : ((json['rows'] as Array<any>).map(PayrollFromJSON)),
    };
}

export function PayrollListToJSON(json: any): PayrollList {
    return PayrollListToJSONTyped(json, false);
}

export function PayrollListToJSONTyped(value?: PayrollList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'rows': value['rows'] == null ? undefined : ((value['rows'] as Array<any>).map(PayrollToJSON)),
    };
}
