...
export function CreateCommissionReportInReturnedPositions200ResponseInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateCommissionReportInReturnedPositions200ResponseInner {
    if (json == null) {
        return json;
    }
...
export function CreateCommissionReportInReturnedPositions200ResponseInnerToJSON(json: any): any {
    return CreateCommissionReportInReturnedPositions200ResponseInnerToJSONTyped(json, false);
}

export function CreateCommissionReportInReturnedPositions200ResponseInnerToJSONTyped(value?: CreateCommissionReportInReturnedPositions200ResponseInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
