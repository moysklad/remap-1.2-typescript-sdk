 ...
 * @export
 * @interface ReportMoneyAccount
 */
export interface ReportMoneyAccount {
    /**
     * 
     * @type {Meta}
     * @memberof ReportMoneyAccount
     */
    meta?: Meta;
    /**
     * Номер счета
...
/**
 * Check if a given object implements the ReportMoneyAccount interface.
 */
export function instanceOfReportMoneyAccount(value: object): value is ReportMoneyAccount {
    return true;
}

export function ReportMoneyAccountFromJSON(json: any): ReportMoneyAccount {
    return ReportMoneyAccountFromJSONTyped(json, false);
}

export function ReportMoneyAccountFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReportMoneyAccount {
    if (json == null) {
        return json;
    }
    return {
...
export function ReportMoneyAccountToJSON(json: any): ReportMoneyAccount {
    return ReportMoneyAccountToJSONTyped(json, false);
}

export function ReportMoneyAccountToJSONTyped(value?: ReportMoneyAccount | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    return {
