...
export interface MoveList {
     ...
     * @memberof MoveList
     */
    rows?: Array<Move> | null;
}


/**
 * Check if a given object implements the MoveList interface.
 */
export function instanceOfMoveList(value: object): value is MoveList {
    return true;
}

export function MoveListFromJSON(json: any): MoveList {
    return MoveListFromJSONTyped(json, false);
}

export function MoveListFromJSONTyped(json: any, ignoreDiscriminator: boolean): MoveList {
    if (json == null) {
        return json;
    }
    return {
        ...
        'rows': json['rows'] == null ? undefined : ((json['rows'] as Array<any>).map(MoveFromJSON)),
    };
}

export function MoveListToJSON(json: any): MoveList {
    return MoveListToJSONTyped(json, false);
}

export function MoveListToJSONTyped(value?: MoveList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'rows': value['rows'] == null ? undefined : ((value['rows'] as Array<any>).map(MoveToJSON)),
    };
}
