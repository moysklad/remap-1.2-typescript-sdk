...
export function CreateInternalOrderPositions200ResponseInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateInternalOrderPositions200ResponseInner {
    if (json == null) {
        return json;
    }
...
export function CreateInternalOrderPositions200ResponseInnerToJSON(json: any): any {
    return CreateInternalOrderPositions200ResponseInnerToJSONTyped(json, false);
}

export function CreateInternalOrderPositions200ResponseInnerToJSONTyped(value?: CreateInternalOrderPositions200ResponseInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
