 ...
 * @export
 * @interface InvoiceInList
 */
export interface InvoiceInList {
    /**
     * 
     * @type {Context}
     * @memberof InvoiceInList
     */
    context?: Context;
    /**
     * 
    ...
    meta?: MetaList;
    /**
     * Массив Счетов поставщикам
     * @type {Array<InvoiceIn>}
     * @memberof InvoiceInList
     */
    rows?: Array<InvoiceIn> | null;
}


/**
 * Check if a given object implements the InvoiceInList interface.
 */
export function instanceOfInvoiceInList(value: object): value is InvoiceInList {
    return true;
}

export function InvoiceInListFromJSON(json: any): InvoiceInList {
    return InvoiceInListFromJSONTyped(json, false);
}

export function InvoiceInListFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvoiceInList {
    if (json == null) {
        return json;
    }
    return {
        ...
        'rows': json['rows'] == null ? undefined : ((json['rows'] as Array<any>).map(InvoiceInFromJSON)),
    };
}

export function InvoiceInListToJSON(json: any): InvoiceInList {
    return InvoiceInListToJSONTyped(json, false);
}

export function InvoiceInListToJSONTyped(value?: InvoiceInList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'rows': value['rows'] == null ? undefined : ((value['rows'] as Array<any>).map(InvoiceInToJSON)),
    };
}
