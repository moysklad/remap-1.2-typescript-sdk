...
export interface ProcessingList {
     ...
     * @memberof ProcessingList
     */
    rows?: Array<Processing>;
}


/**
 * Check if a given object implements the ProcessingList interface.
 */
export function instanceOfProcessingList(value: object): value is ProcessingList {
    return true;
}

export function ProcessingListFromJSON(json: any): ProcessingList {
    return ProcessingListFromJSONTyped(json, false);
}

export function ProcessingListFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProcessingList {
    if (json == null) {
        return json;
    }
    return {
        ...
        'rows': json['rows'] == null ? undefined : ((json['rows'] as Array<any>).map(ProcessingFromJSON)),
    };
}

export function ProcessingListToJSON(json: any): ProcessingList {
    return ProcessingListToJSONTyped(json, false);
}

export function ProcessingListToJSONTyped(value?: ProcessingList | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'rows': value['rows'] == null ? undefined : ((value['rows'] as Array<any>).map(ProcessingToJSON)),
    };
}
