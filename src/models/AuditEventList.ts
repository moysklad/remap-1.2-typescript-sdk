...
export interface AuditEventList {
    ...
    meta?: MetaList;
    /**
     * Массив событий аудита
     * @type {Array<AuditEvent>}
     * @memberof AuditEventList
     */
    rows?: Array<AuditEvent> | null;
}
...
export function AuditEventListFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuditEventList {
    ...
    return {
        ...
        'rows': json['rows'] == null ? undefined : ((json['rows'] as Array<any>).map(AuditEventFromJSON)),
    };
}
...
export function AuditEventListToJSONTyped(value?: AuditEventList | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'rows': value['rows'] == null ? undefined : ((value['rows'] as Array<any>).map(AuditEventToJSON)),
    };
}
